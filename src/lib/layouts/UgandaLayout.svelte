<script lang="ts">
  ...
  type Region = 'stripe1' | 'stripe2' | 'stripe3' | 'stripe4' | 'stripe5' | 'stripe6';
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600">
  <rect
    ...
    width="900"
    height="100"
    {@attach createDroppable({ id: 'stripe1' }).attach}
    fill={getColor('stripe1')}
    stroke={getStroke('stripe1')}
    stroke-width="5"
  />
  ...
  <rect
    ...
    width="900"
    height="100"
    {@attach createDroppable({ id: 'stripe2' }).attach}
    fill={getColor('stripe2')}
    stroke={getStroke('stripe2')}
    stroke-width="5"
  />
  ...
  <rect
    ...
    width="900"
    height="100"
    {@attach createDroppable({ id: 'stripe3' }).attach}
    fill={getColor('stripe3')}
    stroke={getStroke('stripe3')}
    stroke-width="5"
  />
  ...
  <rect
    ...
    width="900"
    height="100"
    {@attach createDroppable({ id: 'stripe4' }).attach}
    fill={getColor('stripe4')}
    stroke={getStroke('stripe4')}
    stroke-width="5"
  />
  ...
  <rect
    ...
    width="900"
    height="100"
    {@attach createDroppable({ id: 'stripe5' }).attach}
    fill={getColor('stripe5')}
    stroke={getStroke('stripe5')}
    stroke-width="5"
  />
  ...
  <rect
    ...
    width="900"
    height="100"
    {@attach createDroppable({ id: 'stripe6' }).attach}
    fill={getColor('stripe6')}
    stroke={getStroke('stripe6')}
    stroke-width="5"
  />
